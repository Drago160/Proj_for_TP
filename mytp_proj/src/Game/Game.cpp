...
Game::Game()
{
	window.create(sf::VideoMode(WINDOW_WEIGHT, WINDOW_HEIGHT), "SIMULATION RUNS!!!");
...
void Game::start()
{
	...
	text2.setPosition(WINDOW_WEIGHT - SCORE_MARGIN_RIGHT, SCORE_MARGIN_TOP + SCORE_DH);
	text3.setPosition(WINDOW_WEIGHT - SCORE_MARGIN_RIGHT, SCORE_MARGIN_TOP + SCORE_DH * 2);
	///////////////////////////////////////////	
	...
	mainRestartButton.setPosition(WINDOW_WEIGHT - RES_BUTTON_MARGIN_RIGHT, RES_BUTTON_MARGIN_TOP);
	...
	while (window.isOpen())
	{
		...
		if (sf::IntRect(WINDOW_WEIGHT - RES_BUTTON_MARGIN_RIGHT, RES_BUTTON_MARGIN_TOP, restartButtonWidth, restartButtonHeight).contains(sf::Mouse::getPosition(window)))
		{
